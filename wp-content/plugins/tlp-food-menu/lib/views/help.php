...
?>
	...
	<div class="rtfm-help-wrapper" >
		<div class="rtfm-help-section rt-document-box">
			...
			<div class="rt-box-content">
				...
				<div class="embed-wrapper">
					<iframe src="https://www.youtube.com/embed/l4xLIPvj-ic" title="Food Menu" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		</div>
		...
		<div class="rtfm-call-to-action" style="background-image: url('<?php echo TLPFoodMenu()->assetsUrl; ?>images/admin/banner.png')">
			<a href="https://www.radiustheme.com/downloads/food-menu-pro-wordpress/" target="_blank" class="rt-update-pro-btn">
				...
				<div class="rtfm-testimonials">
					<div class="rtfm-testimonial">
						...
						<div class="client-info">
							<img src="<?php echo TLPFoodMenu()->assetsUrl; ?>images/admin/client1.jpeg">
							<div>
								<div class="rtfm-star">
					...
					<div class="rtfm-testimonial">
						...
						<div class="client-info">
							<img src="<?php echo TLPFoodMenu()->assetsUrl; ?>images/admin/client2.png">
							<div>
								<div class="rtfm-star">
									<i class="dashicons dashicons-star-filled"></i>
									<i class="dashicons dashicons-star-filled"></i>
		...
		<div class="rtfm-pro-feature-content">
			<div class="rt-document-box">
				...
				<div class="rt-box-content">
					...
					<a href="https://www.radiustheme.com/docs/food-menu/getting-started/installations/" target="_blank" class="rt-admin-btn">Documentation</a>
				</div>
			</div>
			<div class="rt-document-box">
			...
			<div class="rt-document-box">
				...
				<div class="rt-box-content">
					...
					<a href="https://wordpress.org/support/plugin/tlp-food-menu/reviews/?filter=5#new-post" class="rt-admin-btn" target="_blank">Post Review</a>
				</div>
			</div>
		</div>
	</div>
